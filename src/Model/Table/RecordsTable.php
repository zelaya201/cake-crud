...
class RecordsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ...
            ->notEmptyDateTime('record_date');

        $validator
            ->scalar('record_description')
            ->maxLength('record_description', 255)
            ->requirePresence('record_description', 'create')
            ->notEmptyString('record_description');

        $validator
            ->integer('record_quantity')
            ->requirePresence('record_quantity', 'create')
            ->notEmptyString('record_quantity');

        $validator
            ->scalar('record_reference')
            ->maxLength('record_reference', 255)
            ->allowEmptyString('record_reference');

        $validator
            ->integer('record_product_id')
            ->allowEmptyString('record_product_id');
    ...
    {
        $rules->add($rules->existsIn('record_product_id', 'Products'), ['errorField' => 'record_product_id']);
